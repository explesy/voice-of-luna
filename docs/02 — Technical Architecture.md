...
Tool evidence также принадлежит plugin: Project Room возвращает только
структурированные безопасные указатели на прочитанные пути и строки, а core
прикрепляет их к assistant turn и отображает generic evidence-блок. Текст
ответа не может сам объявить произвольный файл источником.
