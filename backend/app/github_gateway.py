...
class GitHubGateway:
    ...
    def _url(self, suffix: str) -> str:
        ...
        return f"https://api.github.com/repos/{self.repository}/{suffix}"
    ...
    async def issues(self, state: str = "open") -> list[dict[str, Any]]:
        async with httpx.AsyncClient(timeout=10.0) as client:
            response = await client.get(self._url("issues"), headers=self._headers(), params={"state": state, "per_page": 30})
